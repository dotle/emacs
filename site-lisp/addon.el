...
(require 'tabbar)
(tabbar-mode)
(global-set-key (kbd "H-4") 'tabbar-backward-group)
(global-set-key (kbd "H-3") 'tabbar-forward-group)
(global-set-key (kbd "H-2") 'tabbar-backward)
(global-set-key (kbd "H-1") 'tabbar-forward)
